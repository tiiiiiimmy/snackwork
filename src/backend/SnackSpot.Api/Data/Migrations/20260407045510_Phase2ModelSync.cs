...
{
    /// <inheritdoc />
    public partial class Phase2ModelSync : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UnlockedFeatures = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLevels", x => x.Level);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Snacks_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SnackId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    UserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SnackImages_Snacks_SnackId",
                        column: x => x.SnackId,
                        principalTable: "Snacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SnackTags_Snacks_SnackId",
                        column: x => x.SnackId,
                        principalTable: "Snacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserViewHistory", x => new { x.UserId, x.SnackId });
                    table.ForeignKey(
                        name: "FK_UserViewHistory_Snacks_SnackId",
                        column: x => x.SnackId,
                        principalTable: "Snacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserViewHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "UserLevels",
                columns: new[] { "Level", "Description", "MaxExperience", "MinExperience", "Title", "UnlockedFeatures" },
                values: new object[,]
                {
                    { 1, "Just getting started on the snack journey.", 99, 0, "Newcomer", null },
                    { 2, "Beginning to explore the snack world.", 299, 100, "Explorer", "[\"create_category\"]" },
                    { 3, "A growing passion for discovering snacks.", 599, 300, "Enthusiast", "[\"follow_users\"]" },
                    { 4, "Developing a refined snack palate.", 999, 600, "Connoisseur", null },
                    { 5, "A seasoned snack aficionado.", 1499, 1000, "Expert", "[\"send_messages\"]" },
                    { 6, "Deep knowledge of the snack ecosystem.", 2199, 1500, "Guru", null },
                    { 7, "Mastery over snack discovery and curation.", 2999, 2200, "Master", "[\"create_store\"]" },
                    { 8, "A legendary figure in the snack community.", 3999, 3000, "Legend", null },
                    { 9, "Mythic status among snack enthusiasts.", 4999, 4000, "Mythic", null },
                    { 10, "Transcended all limits of snack knowledge.", 2147483647, 5000, "Transcendent", "[\"all\"]" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leaderboards_Type_UserId",
                table: "Leaderboards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Snacks_CreatedByUserId",
                table: "Snacks",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserViewHistory_SnackId",
